...
py -m PyInstaller --onefile --console --name "kawauso-kinako-debug" --distpath ".." --workpath "build-debug" --specpath "." --hidden-import selenium.webdriver.chrome.webdriver --hidden-import selenium.webdriver.chrome.service --hidden-import selenium.webdriver.chrome.options --hidden-import webdriver_manager --hidden-import webdriver_manager.chrome --hidden-import pandas --hidden-import numpy --hidden-import openpyxl --hidden-import PyQt6 --hidden-import PyQt6.QtWidgets --hidden-import PyQt6.QtCore --hidden-import PyQt6.QtGui --hidden-import matplotlib --hidden-import asyncio --hidden-import multiprocessing --collect-all TikTokLive --collect-all selenium --collect-all webdriver_manager --collect-all bs4 --collect-all matplotlib --collect-all numpy --collect-all PyQt6 app.py
